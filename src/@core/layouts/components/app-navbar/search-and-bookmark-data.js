...
export default {
  pages: {
    ...
    data: [
      ...
      { title: 'Account Settings', route: { name: 'projects-account-setting' }, icon: 'SettingsIcon', isBookmarked: false },
      ...
      { title: 'Blog Detail', route: { name: 'projects-blog-detail.vue', params: { id: 1 } }, icon: 'FileTextIcon', isBookmarked: false },
      { title: 'Blog Edit', route: { name: 'projects-blog-edit', params: { id: 1 } }, icon: 'FileTextIcon', isBookmarked: false },
      { title: 'Blog List', route: { name: 'projects-blog-list' }, icon: 'FileTextIcon', isBookmarked: false },
      ...
      { title: 'FAQ', route: { name: 'projects-faq' }, icon: 'HelpCircleIcon', isBookmarked: false },
      ...
      { title: 'Knowledge Base Category', route: { name: 'projects-knowledge-base-category' }, icon: 'InfoIcon', isBookmarked: false, },
      { title: 'Knowledge Base Question', route: { name: 'projects-knowledge-base-question' }, icon: 'InfoIcon', isBookmarked: false, },
      { title: 'Knowledge Base', route: { name: 'projects-knowledge-base' }, icon: 'InfoIcon', isBookmarked: false },
      ...
      { title: 'Pricing', route: { name: 'projects-pricing' }, icon: 'DollarSignIcon', isBookmarked: false },
      ...
      { title: 'Profile', route: { name: 'projects-profile' }, icon: 'UserIcon', isBookmarked: false },
